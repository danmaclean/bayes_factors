...
The primary purpose of this course is to help you to understand how to use statistics that will help with your research. The course will try to explain a branch of statistics called 'Bayesian Inference' which is complementary to the normal sort of hypothesis test procedures but is also philosophically quite distinct.
